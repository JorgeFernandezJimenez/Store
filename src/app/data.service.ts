...
export class DataService implements InMemoryDbService {
  ...
  createDb() {
    ...
    let games: Game[] = [
      {id: 0, name: 'God of War', price: 70, stock: 20, category: 0, img: 'assets/img/GoW.jpg'},
      {id: 1, name: "Assassin's Creed: Odyssey", price: 69.95, stock: 10, category: 0, img: 'assets/img/ACO.jpg'},
      {id: 2, name: 'Caesar 3', price: 20, stock: 10, category: 1, img: 'assets/img/CIII.jpg'},
      {id: 3, name: 'Crash Bandicoot 3', price: 5, stock: 5, category: 2, img: 'assets/img/CB3.jpg'}
    ];
